#Problem 67: By starting at the top of the triangle below and moving to adjacent numbers 
...
#(hyperlink to https://projecteuler.net/resources/documents/0067_triangle.txt)(right 
#click and 'Save Link/Target As...'), a 15K text file containing a triangle with one-
#hundred rows. NOTE: This is a much more difficult version of Problem 18. It is not 
#possible to try every route to solve this problem, as there are 299 altogether! If you 
#could check one trillion (1012) routes every second it would take over twenty billion 
