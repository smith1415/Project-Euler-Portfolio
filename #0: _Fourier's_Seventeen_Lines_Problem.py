#Problem: In a 1788 letter to a friend and teacher, Joseph Fourier wrote, "Here is a little problem of a rather singular nature: it occurred to me in connection with certain propositions in Euclid we discussed on several occasions. Arrage 17 lines in the same plane so that they give 101 points of interection. It is to be assumed that the lines extend to infinity, and that no point of intersection belongs to more than two lines"
#After finding one solution (8, 4, 2, 1, 1), I took issue with the very concept that is was a question "singular in nature." I saw no reason why an arragement with 100 points of intersection would be any less interesting. Thus, I wrote this program to find all the numbers of intersections which are possible to make with 17 lines:
