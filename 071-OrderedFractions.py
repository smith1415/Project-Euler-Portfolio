...
"""
#It can be seen that 2/5 is the fraction immediately to the left of 3/7. By listing the 
#set of reduced proper fractions for d<=1000000 in ascending order of size, find the 
