...
#objective of Su Doku puzzles, however, is to replace the blanks (or zeros) in a 9 by 9 
#grid in such that each row, column, and 3 by 3 box contains each of the digits 1 to 9. 
...
#can be solved by straight forward direct deduction. The 6K text file, sudoku.txt 
#(hyperlink to https://projecteuler.net/project/resources/p096_sudoku.txt) (right click 
...
#above). By solving all fifty puzzles find the sum of the 3-digit numbers found in the top 
